...
from the mapped state space (aut file) based on a list of observable actions. The output list is used in mCRL2 tool for reducing the transtion system based on difference equivalence relationships.
