...
from the mapped state space (aut file) based on a list of observable actions. The output list of this function is used as tau (silent) transtions in mCRL2 tool for reducing the transtion system based on difference equivalence relationships.
